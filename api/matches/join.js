...
import { requireUser, json, readBody, handleOptions } from "../../lib/auth.js";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const matchId = String(body.matchId || req.query?.matchId || "").trim();
    ...
    if (existing.length) {
      return json(res, 200, {
        ...
        roomPassword: existing[0].room_password,
      });
    }
